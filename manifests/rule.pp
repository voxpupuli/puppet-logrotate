# @summary Configure logrotate to rotate a logfile.
#
# @param rulename
...
#
# @example Rotate /var/log/syslog daily and keep 7 days worth of compressed logs.
...
#   }
#
# @example Rotate /var/log/nginx/access_log weekly and keep 3 weeks of logs
